...
if (isset($_SESSION['usuario'])) {
    if ($_SESSION['rol'] == 1 || $_SESSION['rol_categorias'] == 1) {
...
?>
    <div class="container-fluid px-4">
        <h3 class="mt-4 text-secondary">CATEGORIAS</h3>
        <a href="/projectFact/view/categoria/create.php" class="btn btn-success" style="margin: 15px 0;">Agregar Categoria</a>
        <div class="card mb-4">
